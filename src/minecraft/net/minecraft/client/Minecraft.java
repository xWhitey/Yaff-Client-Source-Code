...
import store.yaff.feature.impl.misc.Macro;
import store.yaff.feature.impl.world.FastWorldLoad;
import store.yaff.ui.menu.GuiMainMenu;
import store.yaff.ui.screen.SplashScreen;
...
public class Minecraft implements IThreadListener {
    ...
    private void startGame() throws LWJGLException, IOException {
        ...
        SplashScreen screenInstance = new SplashScreen();
        ...
        screenInstance.drawSplash(renderEngine);
        ...
        screenInstance.setProgress(3);
        this.textureMapBlocks = new TextureMap("textures");
        this.textureMapBlocks.setMipmapLevels(this.gameSettings.mipmapLevels);
        screenInstance.setProgress(4);
        ...
        Yaff.of.onInit();
        screenInstance.setProgress(10);
        if (this.gameSettings.fullScreen && !this.fullscreen) {
            this.toggleFullscreen();
        }
        this.scheduleResourcesRefresh();
        screenInstance.setProgress(11);
        try {
    ...
    private void createDisplay() throws LWJGLException {
        ...
        Display.setTitle(Yaff.of.name + " Build " + Yaff.of.build);
        try {
    ...
    private void setWindowIcon() {
        ...
        if (util$enumos != Util.EnumOS.OSX) {
            ...
            try {
                inputstream = Minecraft.class.getResourceAsStream("/assets/minecraft/" + Yaff.of.name + "/" + Yaff.of.name + "_16x16.png");
                inputstream1 = Minecraft.class.getResourceAsStream("/assets/minecraft/" + Yaff.of.name + "/" + Yaff.of.name + "_32x32.png");
    ...
    public void freeMemory() {
        ...
        try {
            if (!Objects.requireNonNull(Yaff.of.featureManager.getFeature(FastWorldLoad.class)).getState()) {
                System.gc();
                this.loadWorld((WorldClient) null);
            }
    ...
    private void runTickKeyboard() throws IOException {
        while (Keyboard.next()) {
            ...
            if (flag) {
                Objects.requireNonNull(Yaff.of.featureManager.getFeatures()).forEach(f -> f.onKeyDown(i));
                if (Objects.requireNonNull(Yaff.of.featureManager.getFeature(Macro.class)).getState()) {
                    Objects.requireNonNull(Yaff.of.macroController.getMacros()).forEach(m -> m.onMacro(i));
                }
                ...
                KeyBinding.setKeyBindState(i, false);
                Objects.requireNonNull(Yaff.of.featureManager.getFeatures()).forEach(f -> f.onKeyUp(i));
                if (i == 61) {
                    if (this.actionKeyF3) {
    ...
    private void middleClickMouse() {
        MiddleClickEvent clickEvent = new MiddleClickEvent();
        clickEvent.call();
