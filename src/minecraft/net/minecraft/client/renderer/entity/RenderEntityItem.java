...
import store.yaff.feature.impl.render.ItemPhysics;
...
public class RenderEntityItem extends Render<EntityItem> {
    ...
    private int transformModelCount(EntityItem itemIn, double p_177077_2_, double p_177077_4_, double p_177077_6_, float p_177077_8_, IBakedModel p_177077_9_) {
        ...
        if (Objects.requireNonNull(Yaff.of.featureManager.getFeature(ItemPhysics.class)).getState()) {
            this.shadowSize = 0.0F;
            int j = getModelCount(itemstack);
            float f3 = (p_177077_9_.getItemCameraTransforms().getTransform(ItemCameraTransforms.TransformType.GROUND)).scale.y;
            GlStateManager.translate((float) p_177077_2_, ((float) p_177077_4_ + 0.25F * f3) - 0.1D, (float) p_177077_6_);
