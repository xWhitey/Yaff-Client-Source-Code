...
import store.yaff.helper.MojangAuth;
...
public class GuiMultiplayer extends GuiScreen {
    ...
    public void createButtons() {
        this.btnSpoofer = this.addButton(new GuiButton(120, 20, 6, 100, 20, "Brand Spoofer"));
        this.btnSpoofer = this.addButton(new GuiButton(121, 128, 6, 100, 20, "Random Alt"));
        this.btnEditServer = this.addButton(new GuiButton(7, this.width / 2 - 154, this.height - 30, 70, 20, I18n.format("selectServer.edit")));
        this.btnDeleteServer = this.addButton(new GuiButton(2, this.width / 2 - 76, this.height - 30, 70, 20, I18n.format("selectServer.delete")));
        this.btnSelectServer = this.addButton(new GuiButton(1, this.width / 2 - 154, this.height - 54, 100, 20, I18n.format("selectServer.select")));
        this.buttonList.add(new GuiButton(4, this.width / 2 - 50, this.height - 54, 100, 20, I18n.format("selectServer.direct")));
        this.buttonList.add(new GuiButton(3, this.width / 2 + 4 + 50, this.height - 54, 100, 20, I18n.format("selectServer.add")));
        this.buttonList.add(new GuiButton(8, this.width / 2 + 2, this.height - 30, 70, 20, I18n.format("selectServer.refresh")));
        this.buttonList.add(new GuiButton(0, this.width / 2 + 4 + 76, this.height - 30, 75, 20, I18n.format("gui.cancel")));
    ...
    protected void actionPerformed(GuiButton button) throws IOException {
        if (button.enabled) {
            ...
            if (button.id == 2 && guilistextended$iguilistentry instanceof ServerListEntryNormal) {
                ...
                this.mc.displayGuiScreen(new GuiBrandSpoofer(this));
            } else if (button.id == 121) {
                MojangAuth auth = new MojangAuth(Yaff.of.stringGenerator.generate(8));
                auth.process();
            }
        }
    }
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        this.drawCenteredString(this.fontRendererObj, I18n.format("multiplayer.title"), this.width / 2, 13, 16777215);
