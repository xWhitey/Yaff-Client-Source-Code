...
public class GuiOptionSlider extends GuiButton {
    ...
    protected void mouseDragged(Minecraft mc, int mouseX, int mouseY) {
        if (this.visible) {
            ...
            Render.drawOutlinedRect(this.xPosition + (int) (this.sliderValue * (float) (this.width - 4)), this.yPosition, 4, 20, 1, Color.rgba(255, 255, 255, 100), Color.rgba(255, 255, 255, 140));
        }
    }
