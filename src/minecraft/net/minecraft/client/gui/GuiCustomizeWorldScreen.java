...
public class GuiCustomizeWorldScreen extends GuiScreen implements GuiSlider.FormatHelper, GuiPageButtonList.GuiResponder {
    ...
    public void initGui() {
        ...
        this.previousPage = this.addButton(new GuiButton(302, 20, 6, 80, 20, I18n.format("createWorld.customize.custom.prev")));
        this.nextPage = this.addButton(new GuiButton(303, this.width - 100, 6, 80, 20, I18n.format("createWorld.customize.custom.next")));
        this.defaults = this.addButton(new GuiButton(304, this.width / 2 - 195, this.height - 41, 90, 20, I18n.format("createWorld.customize.custom.defaults")));
        this.randomize = this.addButton(new GuiButton(301, this.width / 2 - 95, this.height - 41, 90, 20, I18n.format("createWorld.customize.custom.randomize")));
        this.presets = this.addButton(new GuiButton(305, this.width / 2 + 5, this.height - 41, 90, 20, I18n.format("createWorld.customize.custom.presets")));
        this.done = this.addButton(new GuiButton(300, this.width / 2 + 105, this.height - 41, 90, 20, I18n.format("gui.done")));
    ...
    private void createPagedList() {
        ...
        this.list = new GuiPageButtonList(this.mc, this.width, this.height, 32, this.height - 65 + 4, 25, this, aguipagebuttonlist$guilistentry, aguipagebuttonlist$guilistentry1, aguipagebuttonlist$guilistentry2, aguipagebuttonlist$guilistentry3);
        for (int i = 0; i < 4; ++i) {
        ...
        if (button.enabled) {
            switch (button.id) {
                ...
                case 303:
                    ...
                    break;
                case 304:
                    this.mc.displayGuiScreen(new GuiYesNo(this, (new TextComponentTranslation("createWorld.customize.custom.confirmTitle")).getFormattedText(), (new TextComponentTranslation("createWorld.customize.custom.confirm1")).getFormattedText() + " " + (new TextComponentTranslation("createWorld.customize.custom.confirm2")).getFormattedText(), 304));
                    break;
                case 305:
