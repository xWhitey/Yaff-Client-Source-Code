...
public class GuiCreateFlatWorld extends GuiScreen {
    ...
    public void initGui() {
        ...
        this.removeLayerButton = this.addButton(new GuiButton(4, this.width / 2 - 155, this.height - 54, 150, 20, I18n.format("createWorld.customize.flat.removeLayer")));
        this.buttonList.add(new GuiButton(0, this.width / 2 - 155, this.height - 30, 150, 20, I18n.format("gui.done")));
        this.buttonList.add(new GuiButton(5, this.width / 2 - 155 + 160, this.height - 54, 150, 20, I18n.format("createWorld.customize.presets")));
        this.buttonList.add(new GuiButton(1, this.width / 2 - 155 + 160, this.height - 30, 150, 20, I18n.format("gui.cancel")));
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        this.drawCenteredString(this.fontRendererObj, this.flatWorldTitle, this.width / 2, 13, 16777215);
    ...
    class Details extends GuiSlot {
        ...
        public Details() {
            super(GuiCreateFlatWorld.this.mc, GuiCreateFlatWorld.this.width, GuiCreateFlatWorld.this.height, 32, GuiCreateFlatWorld.this.height - 64, 24);
        }
