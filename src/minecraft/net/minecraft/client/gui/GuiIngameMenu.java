...
public class GuiIngameMenu extends GuiScreen {
    ...
    public void initGui() {
        ...
        guiSlot = new GuiSlot(this.width, this.height, 32, this.height, 18);
    }
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        this.drawCenteredString(this.fontRendererObj, I18n.format("menu.game"), this.width / 2, 13, 16777215);
