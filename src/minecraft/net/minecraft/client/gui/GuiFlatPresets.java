...
public class GuiFlatPresets extends GuiScreen {
    ...
    public void initGui() {
        ...
        this.btnSelect = this.addButton(new GuiButton(0, this.width / 2 - 155, this.height - 41, 150, 20, I18n.format("createWorld.customize.presets.select")));
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        this.drawCenteredString(this.fontRendererObj, this.presetsTitle, this.width / 2, 13, 16777215);
        this.drawString(this.fontRendererObj, this.presetsShare, 50, 28, 10526880);
        this.drawString(this.fontRendererObj, this.listText, 50, 66, 10526880);
    ...
    class ListSlot extends GuiSlot {
        ...
        public ListSlot() {
            super(GuiFlatPresets.this.mc, GuiFlatPresets.this.width, GuiFlatPresets.this.height, 80, GuiFlatPresets.this.height - 65 + 4, 24);
        }
