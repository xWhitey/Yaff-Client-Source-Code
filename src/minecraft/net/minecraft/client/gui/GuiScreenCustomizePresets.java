...
public class GuiScreenCustomizePresets extends GuiScreen {
    ...
    public void initGui() {
        ...
        this.select = this.addButton(new GuiButton(0, this.width / 2 - 155, this.height - 41, 150, 20, I18n.format("createWorld.customize.presets.select")));
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        this.drawString(this.fontRendererObj, this.shareText, 50, 28, 10526880);
    ...
    class ListPreset extends GuiSlot {
        ...
        public ListPreset() {
            super(GuiScreenCustomizePresets.this.mc, GuiScreenCustomizePresets.this.width, GuiScreenCustomizePresets.this.height, 80, GuiScreenCustomizePresets.this.height - 65 + 4, 38);
        }
