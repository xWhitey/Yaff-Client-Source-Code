...
public class GuiCreateWorld extends GuiScreen {
    ...
    public void initGui() {
        ...
        this.buttonList.add(new GuiButton(0, this.width / 2 - 155, this.height - 41, 150, 20, I18n.format("selectWorld.create")));
        this.buttonList.add(new GuiButton(1, this.width / 2 - 155 + 160, this.height - 41, 150, 20, I18n.format("gui.cancel")));
        this.buttonList.add(new GuiButton(231, this.width / 2 + 111, 60, 20, 20, "R"));
    ...
    protected void actionPerformed(GuiButton button) throws IOException {
        if (button.enabled) {
            ...
            } else if (button.id == 231) {
                this.worldSeedField.setText(Yaff.of.stringGenerator.generate(32));
            }
        }
    }
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        this.drawCenteredString(this.fontRendererObj, I18n.format("selectWorld.create"), this.width / 2, 13, -1);
        if (this.inMoreWorldOptionsDisplay) {
            ...
            this.drawString(this.fontRendererObj, this.gameModeDesc1, this.width / 2 - mc.fontRendererObj.getStringWidth(this.gameModeDesc1) / 2, 142, -6250336);
            this.drawString(this.fontRendererObj, this.gameModeDesc2, this.width / 2 - mc.fontRendererObj.getStringWidth(this.gameModeDesc2) / 2, 154, -6250336);
        }
