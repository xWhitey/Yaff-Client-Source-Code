...
public abstract class GuiResourcePackList extends GuiListExtended {
    ...
    protected void drawListHeader(int insideLeft, int insideTop, Tessellator tessellatorIn) {
        String s = TextFormatting.BOLD + this.getListHeader();
        this.mc.fontRendererObj.drawString(s, insideLeft + this.width / 2f - this.mc.fontRendererObj.getStringWidth(s) / 2f, 36, 16777215);
    }
