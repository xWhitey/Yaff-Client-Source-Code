...
public class GuiScreenResourcePacks extends GuiScreen {
     ...
     */
    public void initGui() {
        this.buttonList.add(new GuiOptionButton(2, this.width / 2 - 155, this.height - 41, I18n.format("resourcePack.openFolder")));
        this.buttonList.add(new GuiOptionButton(1, this.width / 2 - 155 + 160, this.height - 41, I18n.format("gui.done")));
        if (!this.changed) {
        ...
        this.availableResourcePacksList = new GuiResourcePackAvailable(this.mc, 200, this.height - 10, this.availableResourcePacks);
        this.availableResourcePacksList.setSlotXBoundsFromLeft(this.width / 2 - 4 - 200);
        this.availableResourcePacksList.registerScrollButtons(7, 8);
        this.selectedResourcePacksList = new GuiResourcePackSelected(this.mc, 200, this.height - 10, this.selectedResourcePacks);
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        this.drawCenteredString(this.fontRendererObj, I18n.format("resourcePack.title"), this.width / 2, 13, 16777215);
