...
public class GuiScreenServerList extends GuiScreen {
    ...
    public void initGui() {
        ...
        this.buttonList.add(new GuiButton(0, this.width / 2 - 155, this.height - 41, 150, 20, I18n.format("selectServer.select")));
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        this.drawCenteredString(this.fontRendererObj, I18n.format("selectServer.direct"), this.width / 2, 13, 16777215);
