...
public class GuiYesNo extends GuiScreen {
     ...
     */
    public void initGui() {
        this.buttonList.add(new GuiOptionButton(0, this.width / 2 - 155, this.height - 41, this.confirmButtonText));
        this.buttonList.add(new GuiOptionButton(1, this.width / 2 - 155 + 160, this.height - 41, this.cancelButtonText));
