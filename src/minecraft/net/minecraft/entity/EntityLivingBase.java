...
import store.yaff.event.impl.JumpEvent;
...
public abstract class EntityLivingBase extends Entity {
    ...
    public final float getHurtTime() {
    ...
    public boolean attackEntityFrom(DamageSource source, float amount) {
        if (this.isEntityInvulnerable(source)) {
            ...
            if (this.getHealth() <= 0.0F) {
                ...
                boolean flag1 = true;
                if ((float) this.hurtResistantTime > (float) this.maxHurtResistantTime / 2f) {
    ...
    public void onUpdate() {
        ...
        while (this.renderPitchOffset - this.prevRenderPitchOffset < -180.0F) {
            this.prevRenderPitchOffset -= 360.0F;
        }
        while (this.renderYawOffset - this.prevRenderPitchOffset >= 180.0F) {
            this.prevRenderPitchOffset += 360.0F;
        }
