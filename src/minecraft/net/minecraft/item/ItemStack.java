...
import store.yaff.event.impl.BlockInteractEvent;
...
public final class ItemStack
{
    ...
    public EnumActionResult onItemUse(EntityPlayer playerIn, World worldIn, BlockPos pos, EnumHand hand, EnumFacing side, float hitX, float hitY, float hitZ)
    {
        ...
        {
            playerIn.addStat(Objects.requireNonNull(StatList.getObjectUseStats(this.item)));
        }
    ...
    public boolean attemptDamageItem(int amount, Random rand, @Nullable EntityPlayerMP p_96631_3_)
    {
        ...
        {
            ItemDamageEvent damageEvent = new ItemDamageEvent(this, amount);
            damageEvent.call();
