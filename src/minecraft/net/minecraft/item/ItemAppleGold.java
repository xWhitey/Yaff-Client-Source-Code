...
import store.yaff.feature.impl.combat.AutoGApple;
...
public class ItemAppleGold extends ItemFood
{
    ...
    protected void onFoodEaten(ItemStack stack, World worldIn, EntityPlayer player)
    {
        ...
        if (Objects.requireNonNull(Yaff.of.featureManager.getFeature(AutoGApple.class)).getState() && AutoGApple.trackCooldown.getBooleanValue()) {
            Minecraft.getMinecraft().player.getCooldownTracker().setCooldown(this, 75);
        }
    }
